...
import MultiMenuInput from '../Inputs/MultiMenuInputs';
...
function EditPropertyModal({ data, setData, open1, setOpen1, setList, list ,setButtonLoading }) {
    const { button_loading, handleUpdateProperty, loginData, areaUnit, formatPakistaniPhoneNumber } = useAuth()
    ...
    // Clear location when city is empty
    useEffect(() => {
    ...
    const handleCheckValidation = async () => {
        ...
        // if (!data.videos.some(video => video.trim() !== "")) tempErrors.videos = "At least one video is required.";
        ...
        if (Object.keys(tempErrors).length === 0) {
            ...
            if (result?.success) {
                const updatedProperty = result?.data?.property || data;
                ...
                setData({
                    ...
                    plot_number: 'p-235',
                    areaValue: '',
                    areaUnit: { id: 4, name: "Marla", code: "marla" },
                    priceValue: '',
                    priceUnit: { name: "PKR", id: "PKR" },
                    installment: false,
                    possession: false,
                    advanceAmount: '',
                    no_of_installment: [],
    ...
    return (
        ...
        >
            <Box sx={style} className="edit-property-mui-modal">
                <div className='main-edit-box global-modal-base-color'>
                    <div className='d-flex justify-content-between global-mobile-menu-header'>
                        <h6 className='modal_headig mb-0 heading'>Edit Property</h6>
                    ...
                    <div className='main_edit_modal add-propery portal-page-container '>
                        <div style={{ padding: "12px 12px" }} className="setting-container">
                            <div className="add-property-settings">
                                <div className="setting-section">
                                    ...
                                    <div className="section-inputs">
                                        ...
                                        <MultiMenuInput width={236} errors={errors} label={"Property Type"} data={data} setData={setData} varName={"propertyType"} type="type" subType={"subType"} menuData={subMenu} placeHolder={"Select"} />
                                        <SingleInput forName={"city"} width={236} errors={errors?.city} getVariable={"name"} label={"City"} data={data} setData={setData} varName={"city"} menuData={citiesList} input={true} dropDown={true} placeHolder={"Select"} />
                                        <SingleInput width={236} errors={errors?.location} getVariable={"name"} label={"Location"} data={data} setData={setData} varName={"location"} menuData={locationList} input={false} dropDown={true} placeHolder={"Enter Location"} />
                                    </div>
                                </div>
                                <div className="setting-section price-and-area" style={{ border: 'unset', paddingBottom: "0", gap: 'unset' }}>
                                    ...
                                    <span className='d-flex' style={{ gap: '30px 20px', margin: '16px 0', flexWrap: "wrap" , flexDirection : window.innerWidth <= 576 ? 'column' : '' }}>
                                        <div className="d-flex align-items-end" style={{ gap: '8px', flex: window.innerWidth <= 576 ? '1' : 'none' }}>
                                            <SingleInput errors={errors?.areaValue} label={"Area"} data={data} setData={setData} varName={"areaValue"} input={true} dropDown={false} width={"406px"} placeHolder={"Enter Value"} />
                                            <DropDownField getName={"name"} active={true} data={data} setData={setData} varName={"areaUnit"} menuData={areaUnit} />
                                        </div>
                                        <div className="d-flex align-items-end" style={{ gap: '8px' , flex: window.innerWidth <= 576 ? '1' : 'none' }}>
                                            <SingleInput priceChanger={formatNumber(data?.priceValue)} errors={errors?.priceValue} label={"Price"} data={data} setData={setData} varName={"priceValue"} input={true} dropDown={false} width={"406px"} placeHolder={"Enter Amount"} />
                                            <DropDownField getName={"name"} data={data} setData={setData} varName={"priceUnit"} menuData={unit} />
                                        </div>
                                    </span>
                                    <span className='d-flex w-100 optional-box' style={{ gap: "20px 320px" , flexDirection : window.innerWidth <= 576 ? 'column' : '' }}>
                                        <div className="input-box">
                                    ...
                                    </span>
                                    {
                                        ...
                                        <>  <div className="seperator-line"></div>
                                            <span className='d-flex' style={{ gap: '16px 20px', flexWrap: 'wrap' , flexDirection : window.innerWidth <= 576 ? 'column' : '' }}>
                                                <div className="d-flex align-items-end" style={{ gap: '8px' , flex: window.innerWidth <= 576 ? '1' : '' }}>
                                                    <SingleInput errors={errors?.advanceAmount} label={"Advance Amount"} data={data} setData={setData} varName={"advanceAmount"} input={true} dropDown={false} width={"406px"} placeHolder={"Enter Amount"} />
                                                    <DropDownField data={data} setData={setData} varName={"priceUnit"} menuData={unit} />
                                                </div>
                                                <div className="d-sm-flex d-none align-items-end  installment-input" style={{ gap: '8px' , width: window.innerWidth <= 576 ? '100%' : 'auto' }}>
                                                    <div className="input-box" style={{ width: window.innerWidth <= 576 ? '100%' : '' }}>
                                                        <label style={{ marginBottom: '8px' }}>No. of Installments</label>
                                                        <DropDownField active={true} errors={errors?.no_of_installment} data={data} setData={setData} varName={"no_of_installment"} getName={'name'} label={"Enter Value"} menuData={installmentNumber} width={"512px"} />
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-end" style={{ gap: '8px' , flex: window.innerWidth <= 576 ? '1' : '' }}>
                                                    <SingleInput errors={errors?.monthlyInstallment} label={"Monthly Installments"} data={data} setData={setData} varName={"monthlyInstallment"} input={true} dropDown={false} width={"406px"} placeHolder={"Enter Amount"} />
                                                    <DropDownField data={data} setData={setData} varName={"priceUnit"} menuData={unit} />
                                                </div>
                                                <div className="d-sm-none d-flex align-items-end  installment-input" style={{ gap: '8px' , width: window.innerWidth <= 576 ? '100%' : 'auto' }}>
                                                    <div className="input-box" style={{ width: window.innerWidth <= 576 ? '100%' : '' }}>
                                                        <label style={{ marginBottom: '8px' }}>No. of Installments</label>
                                                        <DropDownField active={true} errors={errors?.no_of_installment} data={data} setData={setData} varName={"no_of_installment"} getName={'name'} label={"Enter Value"} menuData={installmentNumber} width={"512px"} />
                                                    </div>
                                    ...
                                    <div className="features mt-1">
                                        {data?.amenities && data?.amenities?.length > 0 ? (
                                            ...
                                            Object.entries(
                                                ...
                                                // Find category name from the available categories loaded in amenities state
                                                const category = amenities.find(cat => cat.id == categoryId);
                                                const categoryName = category?.name || categoryAmenities[0]?.category_name || `Category ${categoryId}`;
                                ...
                                <div className="setting-section">
                                    ...
                                    <div className={`image-section mt-1 ${errors.images ? "error" : ""}`} style={{ position: "relative" }}>
                                        <div className="row m-0">
                                            <div className="col-12 p-0 d-flex align-items-center justify-content-md-start justify-content-between" style={{ gap: '20px', flexWrap: "wrap" }}>
                                                <div className="title">Upload Images of your Property</div>
                                                <span className="ms-3">
                                                    {/* Hidden file input */}
                                                    <input
                                                        type="file"
                                            ...
                                            <div className="posted-images-section">
                                                {images?.map((img, index) => (
                                                    <div className="img">
                                                        <Image src={img?.url ? img.url : img} alt={`upload-${index}`} />
                                ...
                                <div className="setting-section">
                                    ...
                                    <div className="section-inputs last-section" style={{ flexWrap: 'wrap' }}>
                                        <SingleInput errors={errors?.email} label={"Email"} data={data} setData={setData} varName={"email"} input={true} dropDown={false} width={"512px"} inputType={'email'} placeHolder={"Enter your Email"} />
                                        <SingleInput errors={errors?.landline} label={"Landline"} data={data} setData={setData} varName={"landline"} input={true} dropDown={false} width={"512px"} placeHolder={"Enter your Landline 0xx-xxxxxxx"} />
                                        <SingleInput errors={!data?.contact?.[0] ? errors?.contact : errors?.contactSyntax?.[0]} label="Contact no. 1" index={0} data={data} setData={setData} varName="contact" input inputType="text" dropDown={false} width="512px" placeHolder="Enter mobile number" />
                                        <SingleInput errors={errors?.contactSyntax?.[1]} label="Contact no. 2" index={1} data={data} setData={setData} varName="contact" input inputType="text" dropDown={false} width="512px" placeHolder="Enter mobile number" />
                                    </div>
                                </div>
                            ...
                            <div className='footer' style={{ borderRadius: "0 0 12px 12px" }}>
                                <div className="bottom-box global-footer-button-box" style={{ borderRadius: "0 0 12px 12px" }}>
