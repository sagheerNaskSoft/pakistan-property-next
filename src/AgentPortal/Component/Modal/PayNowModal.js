...
function PayNowModal({ open, setOpen }) {
    const { craeteOrder, loading } = useAuth()
    ...
    return (
        ...
        >
            <Box sx={style} className='new_payment_modal'>
                <div
                    className="modal_feature payment_modal global-modal-base-color"
                >
                    <div className="global-modal-paddingBox">
                    <div className="d-flex flex-column-reverse justify-content-between align-items-center">
                        <h4 className="heading p-0 m-0 w-100">Payment Confirmation</h4>
                        <div
                    ...
                    <h6 className="p-0 m-0">
                        Submit your payment receipt to complete your order.
                    </h6>
                    <p className="pera_text my-2 p-0 m-0">
                        Once submitted and verified by the administration, your
                        order will be successfully processed, and you will receive
                    ...
                    <div className="model_footer d-flex justify-content-end global-modal-footer mt-3">
                    <button onClick={() => {
                            setFileName("")
                            setData({ ...data, image: "" });
                            handleClose()
                        ...
                        <button onClick={submit} className="add_btn">
                            {loading ? (
                                <div
