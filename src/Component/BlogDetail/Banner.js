...
function Banner({ blogData, categoryList, blogSlider, setBlogSlider }) {
    ...
    const { objectToQueryString, getAd } = useAuth()
    ...
    // Insert horizontal ads in blog content
        ...
        <>
            ...
            <div className='blog-detail-container main-container'>
                <span className='d-sm-block d-none'>
                    <BreadCrumb items={['Home', "Blogs", decodedSlug]} paths={["/", "/blogs"]} />
                </span>
                ...
                <div className='blog--detail-img'>
                    <FallbackImage src={blogData?.featured_image_url} alt={blogData?.featured_image_alt} componentName="BlogDetail" />
                </div>
                ...
                <div className={window?.innerWidth >= 992 ? "row" : "row m-0"}>
                    ...
                    <div className='blo d-sm-block d-none' >
                        <div className="d-flex">
                            <h5 className='d-sm-none d-block'>Blog Type:</h5><h5>{blogData?.category}</h5>
                        </div>
                        <h6 className='d-sm-block d-none'>{formatDate(blogData?.published_at)}</h6>
                    </div>
                    <div className='blo'>
                        <h5>Posted By:</h5>
                        <span className='d-sm-inline-block d-none' ><svg style={{ cursor: 'pointer' }} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className='col-lg-3 d-sm-block d-none'>
                        {getFilteredAds.vertical.map((item) => (
                            <a key={item.id} href={item?.url} target='_blank' rel="noopener noreferrer" className="d-block mb-3">
